 ...
 * @author Acer
 */
public class Usercard3 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usercard3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

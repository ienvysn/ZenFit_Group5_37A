...
public class TrainerDashboardadmin extends javax.swing.JFrame {
    ...
    MembersText.setText("Members"); // Update the title if needed
...
if (!idText.equals("Enter Id ")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrainerDashboardadmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
